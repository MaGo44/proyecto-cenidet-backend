...
CREATE TABLE student_info (
    ...
    student_cel_phone VARCHAR(10) DEFAULT NULL,
...
CREATE TABLE internal_adviser_info (
    ...
    internal_phone VARCHAR(10) DEFAULT NULL,
    internal_cel_phone VARCHAR(10) DEFAULT NULL,
...
CREATE TABLE company_info (
    ...
    company_cel VARCHAR(10) DEFAULT NULL,
